...
ggplot(na.omit(pracdat), aes(x = Age, y = Total_Met_Min, color = gender)) + geom_line(size = 1) + facet_grid(. ~ gender) + theme_bw() + theme(panel.grid = element_blank())
