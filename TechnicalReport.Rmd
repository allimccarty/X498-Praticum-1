...
The first obvious thing to note is that BMI and body weight are positively correlated.  This should be expected, becuase we caluclated BMI via a linear combination including body weight.
