...
pracdat.transformed = pracdat
pracdat.transformed$lbs_gained <- log(pracdat.transformed$lbs_gained+1)
pracdat.transformed$pounds_gained <- log(pracdat.transformed$pounds_gained+1)
pracdat.transformed$VigTime <- log(pracdat.transformed$VigTime+1)
pracdat.transformed$WalkTime <- log(pracdat.transformed$WalkTime+1)
pracdat.transformed$ModTime <- log(pracdat.transformed$ModTime+1)
pracdat.transformed$Total_Met_Min <- log(pracdat.transformed$Total_Met_Min+1)
