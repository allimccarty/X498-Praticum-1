...
ggplot(na.omit(pracdat), aes(x= gender, y = BMI_change)) + geom_boxplot(aes(color = gender)) + facet_grid(. ~ shift) + theme_minimal() + theme(axis.test.x = element_text(angle=90, hjust=1)) + ggtitle("Change in BMI for Each Time Shift")
